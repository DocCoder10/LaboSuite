                <section class="lms-stack" data-editor-section="category" hidden>
                    ...
                    <div class="lms-stack" data-category-parameter-area>
                        ...
                        <form method="POST" action="{{ route('catalog.parameters.store') }}" data-editor-form="category-parameter" class="lms-stack">
                            ...
                            <label class="lms-field" data-value-type-field="number text"><span>{{ __('messages.reference') }}</span><input name="reference" data-editor-input="category-parameter-reference" placeholder="{{ __('messages.reference_placeholder_number') }}"></label>
